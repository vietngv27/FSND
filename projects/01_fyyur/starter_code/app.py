...
def venues():
  ...
  for venue in venues:
    ...
    if venue.state == prevState and venue.city == prevCity:
      venueGroup['venues'].append(venue_data)
    else:
      if prevState:
        data.append(venueGroup)
        venueGroup = {}
      venueGroup['state'] = venue.state
      venueGroup['city'] = venue.city
      venueGroup['venues'] = [venue_data]
...
def show_venue(venue_id):
  ...
  data = {
    ...
    'phone': venue.phone,
    'genres': venue.genres.split(','),  # convert string to list
...
def show_artist(artist_id):
  ...
  data = {
    ...
    'state': artist.state,
    'phone': artist.phone,
    'genres': artist.genres.split(','),  # convert string to list
